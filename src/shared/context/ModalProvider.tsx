...
const ModalProvider = (props: ModalProviderProps) => {
  ...
  return (
    <SnackbarContext.Provider value={{ openModal, closeModal }}>
      ...
      <Modal footer={false} className={styles.modal} centered width={700} open={state.isOpen} onOk={closeModal} onCancel={closeModal}>
        {state.content}
      </Modal>
      {/* <Modal className={styles.content}>{state.content}</Modal> */}
      {/* </div> */}
      {props.children}
